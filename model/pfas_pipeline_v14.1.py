"""
PFAS Bioaccumulation Data Pipeline v14.0
=========================================
...
def main():
    print("\n" + "═" * 60)
    print("  PFAS Bioaccumulation Pipeline v14.1")
    print("  v14.1: Class-conditional k1_fac — sulfonates only (carboxylate K_FAC=0)")
