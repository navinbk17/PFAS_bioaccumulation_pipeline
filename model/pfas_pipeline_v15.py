"""
PFAS Bioaccumulation Data Pipeline v15.0
=========================================
...
def main():
    print("\n" + "═" * 60)
    print("  PFAS Bioaccumulation Pipeline v15.0")
    ...
    # ── SUMMARY ─────────────────────────────────────────────────────
    print("\n" + "═" * 60)
    print("  Held-out Test Results — v14.1")
    print("═" * 60)
    ...
    v13_refs = {"PFOS": -95, "PFHxS": -88, "PFBS": -72,
    ...
    if len(ag_with_data) > 0:
        ...
        for _, r in ag_with_data.iterrows():
            ...
            pct_v13 = v13_refs.get(r["PFAS_Name"], np.nan)
            pct_v12 = {"PFOS": -91, "PFHxS": -85, "PFBS": -84,
                       "PFOA": +5,  "PFDA":  +2,  "PFNA": -63}.get(r["PFAS_Name"], np.nan)
        ...
        if sulfonate_v14_errs:
            ...
            all_improved = all(abs(e) < abs(v13_refs.get(n, e)) for n, e in sulfonate_v14_errs)
            if all_closed:
